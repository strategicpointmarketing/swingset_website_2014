{*
11eab79ce64a666c737f3f7778b57b90213a9fce, v20 (xcart_4_6_2), 2014-01-31 21:47:53, product_details.tpl, aim
  ...
  <table cellspacing="0" class="product-properties" summary="{$lng.lbl_description|escape}">
	...
	<tr>
		...
		{if $product.appearance.has_market_price and $product.appearance.market_price_discount gt 0}
			...
			<span class="you-save">{$lng.lbl_saving} {math equation="x-y" x=$product.taxed_price y=$product.list_price assign="you_save"}{currency value=$you_save}</span>
		{/if}
