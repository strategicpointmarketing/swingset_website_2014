...
{if $f_products ne ""}
  ...
  {/capture}
  {include file="customer/dialog.tpl" title=$lng.lbl_featured_products content=$smarty.capture.dialog sort=false additional_class="products-dialog dialog-featured-list"}
{/if}
