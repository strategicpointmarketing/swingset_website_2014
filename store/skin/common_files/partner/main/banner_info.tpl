{*
850e5138e855497e58a9e99e00c2e8e04e3f7234, v1 (xcart_4_4_0_beta_2), 2010-05-21 08:31:50, banner_info.tpl, joy
        ...
        <tr{cycle values=', class="TableSubHead"'}>
          ...
          <td>
            ...
            {if $v.target and $v.targetid and $v.target_name}
              ...
              {if $v.target eq 'P'}
                ({$lng.lbl_product}: {$v.target_name|truncate:50})

              {elseif $v.target eq 'C'}
                ({$lng.lbl_category}: {$v.target_name|truncate:50})

              {elseif $v.target eq 'F'}
                ({$lng.lbl_manufacturer}: {$v.target_name|truncate:50})
