{*
8faeb12f1c73aa112ed3404e046e0d7ce670780d, v14 (xcart_4_5_5), 2012-12-28 18:48:11, register.tpl, random
...
<form action="{$register_script_name}?{$php_url.query_string|escape}" method="post" name="decisionform">
