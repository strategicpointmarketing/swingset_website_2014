{*
5cc9610298ef43b7657ea422205e6381a46430d4, v3 (xcart_4_5_2), 2012-07-06 10:44:16, promotions.tpl, tito
...
{if $active_modules.Advanced_Customer_Reviews ne ""}
  {include file="main/promotion_link.tpl" title=$lng.lbl_acr_reviews_management href="`$catalogs.provider`/reviews.php" promo_note=$lng.txt_acr_search_edit_reviews}
{/if}
