{*
b2f85051f676c6240d8bc6da075fb8cbb1006884, v4 (xcart_4_6_1), 2013-09-05 17:11:28, order_invoice.tpl, aim
...
{/if}
{foreach from=$_userinfo.additional_fields item=v}{if $v.section eq 'B' and $v.value.B ne ''}
{$v.title|mail_truncate}{$v.value.B}
{/if}{/foreach}
...
{/if}
{foreach from=$_userinfo.additional_fields item=v}{if $v.section eq 'B' and $v.value.S ne ''}
{$v.title|mail_truncate}{$v.value.S}
