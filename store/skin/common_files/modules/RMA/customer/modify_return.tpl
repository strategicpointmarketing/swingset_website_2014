{*
3039bf3eb094e2b4575469bee1921cf07373145a, v3 (xcart_4_6_1), 2013-07-26 16:43:32, modify_return.tpl, random
      ...
      <tr>
        ...
        <td>
          ...
          {if $return.product.productid gt 0}
            <a href="{$catalogs.customer}/product.php?productid={$return.product.productid}&amp;is_admin_preview=Y">{$return.product.product} ({$return.amount} {$lng.lbl_items})</a>
          {else}
