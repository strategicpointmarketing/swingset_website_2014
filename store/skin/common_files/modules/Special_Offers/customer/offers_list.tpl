{*
6496dece8ceb2809619c47963ec8f81f7b9431d2, v5 (xcart_4_6_1), 2013-09-06 14:50:13, offers_list.tpl, aim
  ...
  {else}
    ...
    {foreach name=offers from=$offers item=offer}
      ...
      <div class="text-block">
        ...
        {elseif $offer.offer_name ne ""}

            <tt>{$offer.offer_name|escape}</tt>
