{*
c042a5293fc990f44ce08ddf7f05f97155dd9243, v4 (xcart_4_6_0), 2013-02-20 18:12:08, order_edit.tpl, random
...
{/if}
{if $active_modules.Abandoned_Cart_Reminder ne ""}
  <td class="ButtonsRow">&nbsp;</td>
  <td class="ButtonsRow">{include file="modules/Abandoned_Cart_Reminder/go_to_abandoned_carts_button.tpl"}</td>
{/if}
</tr>
</table>
