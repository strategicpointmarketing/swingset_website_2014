{*
ce1105ea5a9f9f4a3f06ac9e6aef528e5dccf182, v6 (xcart_4_6_1), 2013-08-13 18:10:46, edit_customer.tpl, aim
...
<tr{cycle name=c2 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_title}</td>
  <td>
    {include file="main/title_selector.tpl" name="address_book[B][titleid]" id="b_titleid" val=$cart_customer.b_titleid use_title_id="Y"}
  </td>
...
<tr{cycle name=c2 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_first_name}</td>
  <td><input type="text" name="address_book[B][firstname]" size="32" maxlength="128" value="{$cart_customer.b_firstname|escape}" /></td>
...
<tr{cycle name=c2 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_last_name}</td>
  <td><input type="text" name="address_book[B][lastname]" size="32" maxlength="128" value="{$cart_customer.b_lastname|escape}" /></td>
...
<tr{cycle name=c2 values=', class="TableSubHead"'}>
  ...
  <td><input type="text" name="address_book[B][address]" size="32" maxlength="255" value="{$cart_customer.b_address|escape}" /></td>
...
<tr{cycle name=c2 values=', class="TableSubHead"'}>
  ...
  <td><input type="text" name="address_book[B][address_2]" size="32" maxlength="128" value="{$cart_customer.b_address_2|escape}" /></td>
...
<tr{cycle name=c2 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_city}</td>
  <td><input type="text" name="address_book[B][city]" size="32" maxlength="64" value="{$cart_customer.b_city|escape}" /></td>
...
<tr{cycle name=c2 values=', class="TableSubHead"'}>
  ...
  <td>{include file="main/counties.tpl" counties=$counties name="address_book[B][county]" default=$cart_customer.b_county}</td>
...
<tr{cycle name=c2 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_state}</td>
  <td>{include file="main/states.tpl" states=$states name="address_book[B][state]" default=$cart_customer.b_state default_country=$cart_customer.b_country}</td>
...
<tr{cycle name=c2 values=', class="TableSubHead"'}>
  ...
  <td>
  <select name="address_book[B][country]" id="customer_info_b_country" onchange="javascript: check_zip_code_field(this.form['address_book[B][country]'], this.form['address_book[B][zipcode]']);">
...
<tr{cycle name=c2 values=', class="TableSubHead"'}>
    ...
    <td>{include file="main/zipcode.tpl" val=$cart_customer.b_zipcode zip4=$cart_customer.b_zip4 name="address_book[B][zipcode]" id="customer_info_b_zipcode"}</td>
...
<tr{cycle name=c4 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_phone}</td>
  <td><input type="text" name="address_book[B][phone]" size="32" maxlength="32" value="{$cart_customer.b_phone|escape}" /></td>
...
<tr{cycle name=c4 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_fax}</td>
  <td><input type="text" name="address_book[B][fax]" size="32" maxlength="32" value="{$cart_customer.b_fax|escape}" /></td>
...
<tr{cycle name=c1 values=', class="TableSubHead"'}>
  <td>{$v.title}</td>
  <td>
<input type="text" name="additional_fields[{$k}][value][B]" value="{$v.value.B|escape}" />
<input type="hidden" name="additional_fields[{$k}][fieldid]" value="{$v.fieldid}" />
<input type="hidden" name="additional_fields[{$k}][section]" value="{$v.section}" />
<input type="hidden" name="additional_fields[{$k}][title]" value="{$v.title}" />
  </td>
...
<tr{cycle name=c3 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_title}</td>
  <td>
    {include file="main/title_selector.tpl" name="address_book[S][titleid]" id="s_titleid" val=$cart_customer.s_titleid use_title_id="Y"}
  </td>
...
<tr{cycle name=c3 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_first_name}</td>
  <td><input type="text" name="address_book[S][firstname]" size="32" maxlength="128" value="{$cart_customer.s_firstname|escape}" /></td>
...
<tr{cycle name=c3 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_last_name}</td>
  <td><input type="text" name="address_book[S][lastname]" size="32" maxlength="128" value="{$cart_customer.s_lastname|escape}" /></td>
...
<tr{cycle name=c3 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_address}</td>
  <td><input type="text" name="address_book[S][address]" size="32" maxlength="255" value="{$cart_customer.s_address|escape}" /></td>
...
<tr{cycle name=c3 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_address_2}</td>
  <td><input type="text" name="address_book[S][address_2]" size="32" maxlength="128" value="{$cart_customer.s_address_2|escape}" /></td>
...
<tr{cycle name=c3 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_city}</td>
  <td><input type="text" name="address_book[S][city]" size="32" maxlength="64" value="{$cart_customer.s_city|escape}" /></td>
...
<tr{cycle name=c2 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_county}</td>
  <td>{include file="main/counties.tpl" counties=$counties name="address_book[S][county]" default=$cart_customer.s_county}</td>
...
<tr{cycle name=c3 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_state}</td>
  <td>{include file="main/states.tpl" states=$states name="address_book[S][state]" default=$cart_customer.s_state default_country=$cart_customer.s_country}</td>
...
<tr{cycle name=c3 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_country}</td>
  <td>
  <select name="address_book[S][country]" id="customer_info_s_country" onchange="javascript: check_zip_code_field(this.form['address_book[S][country]'], this.form['address_book[S][zipcode]']);">
  {section name=country_idx loop=$countries}
...
<tr{cycle name=c3 values=', class="TableSubHead"'}>
    <td>{$lng.lbl_zip_code}</td>
    <td>{include file="main/zipcode.tpl" val=$cart_customer.s_zipcode zip4=$cart_customer.s_zip4 name="address_book[S][zipcode]" id="customer_info_s_zipcode"}</td>
...
<tr{cycle name=c4 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_phone}</td>
  <td><input type="text" name="address_book[S][phone]" size="32" maxlength="32" value="{$cart_customer.s_phone|escape}" /></td>
...
<tr{cycle name=c4 values=', class="TableSubHead"'}>
  <td>{$lng.lbl_fax}</td>
  <td><input type="text" name="address_book[S][fax]" size="32" maxlength="32" value="{$cart_customer.s_fax|escape}" /></td>
...
{$v.title}
  ...
  <td><input type="text" name="additional_fields[{$k}][value][S]" value="{$v.value.S|escape}" /></td>
  <td>{$v.value.S}</td>
</tr>
{/if}
{/foreach}
