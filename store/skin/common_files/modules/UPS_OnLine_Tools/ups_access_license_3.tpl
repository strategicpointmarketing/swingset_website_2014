{*
6f49656773fb506ba318057018fb5676fa887f18, v2 (xcart_4_6_1), 2013-08-27 11:29:53, ups_access_license_3.tpl, aim
...
<tr>
  ...
  <td>{include file="buttons/button.tpl" button_title=$lng.lbl_next title=$lng.lbl_next style="button" href="javascript: if (checkEmailAddress(document.upsstep3form.email)) document.upsstep3form.submit()"}</td>
  <td><img src="{$ImagesDir}/spacer.gif" width="50" height="1" alt="" /></td>
