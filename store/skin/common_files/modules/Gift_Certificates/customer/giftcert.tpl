{*
72bcb996300964e6a7b13648f5941b7bb91adaa2, v10 (xcart_4_6_2), 2014-01-22 14:22:43, giftcert.tpl, mixon
...
{capture name=dialog}
  ...
  <form action="giftcert.php" method="post" name="registergiftcert" onsubmit="javascript: if (this.gcid.value != '') return true; alert(lbl_giftcertid_is_empty); return false;">
    ...
    <div class="valign-middle">
      ...
      {if $login eq "" and $active_modules.Image_Verification and $show_antibot.on_giftcert_check eq 'Y'}
        {include file="modules/Image_Verification/spambot_arrest.tpl" mode="advanced" id=$antibot_sections.on_giftcert_check antibot_err=$antibot_giftcert_check_err button_code=$submit_button antibot_name_prefix='_on_giftcert_check'}
      {else}
        {$submit_button}
      {/if}
  ...
  {if $gc_array}
    ...
    <hr {if $login eq ""}class="giftcert-info"{/if}/>
