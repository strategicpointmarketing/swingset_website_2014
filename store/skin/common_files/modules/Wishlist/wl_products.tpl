{*
04fde8f686ed0be7315b88835142e1a07fc30925, v11 (xcart_4_6_2), 2014-01-04 06:59:41, wl_products.tpl, random
            ...
            <tr>
              ...
              <td class="details">
                ...
                {if $active_modules.XPayments_Subscriptions and $product.subscription}
                  {assign var="price" value=$product.taxed_price+$product.subscription.fee}
                {/if}
                ...
                {if $product.amount_remain gt 0 or $allow_edit}
                  {if $active_modules.XPayments_Subscriptions and $product.subscription}
                    {include file="modules/XPayments_Subscriptions/customer/cart_product.tpl"}
                  {/if}
