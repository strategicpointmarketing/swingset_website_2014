{*
3039bf3eb094e2b4575469bee1921cf07373145a, v3 (xcart_4_6_1), 2013-07-26 16:43:32, product_links.tpl, random
...
<tr{cycle values=", class='TableSubHead'"}>
  ...
  <td class="DataTable"><a href="{$catalogs.customer}/product.php?productid={$product_links[cat_num].productid}&amp;is_admin_preview=Y" class="ItemsList">{$product_links[cat_num].product|truncate:35:"...":false|amp}</a></td>
</tr>
{/section}
