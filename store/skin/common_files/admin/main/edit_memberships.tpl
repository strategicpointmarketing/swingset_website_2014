{*
e3a9528621cf022f9f87ebecaa4d46048c63462d, v3 (xcart_4_6_2), 2014-01-22 11:42:07, edit_memberships.tpl, mixon
...
{/if}
  ...
  {/if}
  <td align="center">{if $v.users ne 0}<a href="users.php?extnd_usearch=Y&amp;posted_data[membershipid]={$type}-{$v.membershipid}">{$v.users}</a>{else}{$lng.txt_not_available}{/if}</td>
</tr>
{/foreach}
