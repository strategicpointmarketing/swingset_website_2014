{*
d1ec7a094f2d7056d2e00dddfdf1d39be41d2397, v2 (xcart_4_6_1), 2013-06-10 12:27:37, category_del_confirmation.tpl, random
...
<dd><a href="{$catalogs.customer}/product.php?productid={$subcats[subcat].products[product].productid}&amp;is_admin_preview=Y" target="_blank">#{$subcats[subcat].products[product].productid}. {$subcats[subcat].products[product].productcode} {$subcats[subcat].products[product].product}</a></dd>
{/section}
</dl>
{/if}
</li>
