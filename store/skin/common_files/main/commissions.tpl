{*
5aef6f605875eafeb744a0e53fffc803b523075b, v8 (xcart_4_4_5), 2011-12-28 11:53:47, commissions.tpl, aim
        ...
        {foreach from=$orders item=v}
          ...
          <tr{cycle values=', class="TableSubHead"'}>
            ...
            <td align="right" nowrap="nowrap">
              ...
              {*like ajax.core.loadBlock($('#xcart_news_items'), 'latest_xcart_news')*}
