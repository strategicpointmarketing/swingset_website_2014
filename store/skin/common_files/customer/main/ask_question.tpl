{*
4bb2522714d05de641b450dcf0ae97372e402eb0, v6 (xcart_4_6_2), 2014-01-24 17:41:59, ask_question.tpl, aim
...
<form action="{$xcart_web_dir}/popup_ask.php" method="post" name="askform">
  ...
  <table cellspacing="1" cellpadding="3" class="product-ask-form">
    ...
    <tr>
      ...
      <td>
        <input type="text" name="uname" id="uname" value="{if $login ne ''}{$fullname|default:$login|escape}{/if}" size="30" autofocus />
      </td>
    </tr>
