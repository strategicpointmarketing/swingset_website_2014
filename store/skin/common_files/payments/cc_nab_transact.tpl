{*
2ca2b62fcb1a7c20f41c4ca934f46b4462e76fdf, v2 (xcart_4_5_5), 2012-11-09 16:13:25, cc_nab_transact.tpl, aim
...
<tr>
  <td><b>{$lng.lbl_cc_nab_transact_hpp_send_detailed_info}:</b><br />{$lng.txt_cc_nab_transact_display_comments_explain}</td>
  <td>
    <select name="param06">
    ...
    </select>{include file="main/tooltip_js.tpl" text=$lng.txt_cc_nab_transact_hpp_send_detailed_info_help id="send_detailed_info_help" type='img' width=400}
  </td>
</tr>
