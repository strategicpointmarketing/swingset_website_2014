{*
6486ecc4134c0d67f4d49e175745f4de118df0cc, v7 (xcart_4_5_5), 2012-11-13 13:05:30, ps_paypal_express.tpl, random
...
<table class="paypal-method-settings">
  ...
  <tr class="first">
    <td class="setting-name">
      <input type="radio" name="paypal_express_method" value="email" id="method_email"{if $config.paypal_express_method ne 'api'} checked="checked"{/if} onclick="javascript: changeExpressMethod();" />
