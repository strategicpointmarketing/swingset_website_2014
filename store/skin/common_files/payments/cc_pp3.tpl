{*
b1769818c678e090986d689f0666788548b79a15, v3 (xcart_4_6_0), 2013-02-25 18:21:28, cc_pp3.tpl, aim
...
<td>{if $config.Security.use_https_login eq 'Y'}{$https_location}{else}{$http_location}{/if}/payment/ebank_validation.php</td>
</tr>
<tr>
<td>{$lng.lbl_pp3_confirmation_script}:</td>
<td>{if $config.Security.use_https_login eq 'Y'}{$https_location}{else}{$http_location}{/if}/payment/ebank_confirmation.php</td>
</tr>
