    ...
    {if $products ne ""}
        ...
        <form action="cart.php" method="post" name="cartform">
            ...
            <div class="gd-row gt-row gm-row">
                <div class="gd-two-thirds gd-columns gt-two-thirds gt-columns gm-two-thirds gm-columns">
                    <!--item heading-->
                    <h3 class="primary-color secondary-font paragon-text mbs bold">Item</h3>
                </div>

                <div class="gd-third gd-columns gt-third gt-columns gm-third gm-columns">
                    <!--subtotal heading-->
            ...
            {foreach from=$products item=product name=products}
                {if $product.hidden eq ""}
                    <div class="gd-row gt-row gm-row pvm clear">
                        <div class="gd-two-thirds gd-columns gt-two-thirds gt-columns gm-two-thirds gm-columns">
                            <!-- Product name/link -->
...
<div class="gd-row gt-row">
    ...
    <div class="gd-third gd-columns gt-third gt-columns">
        ...
        <a href = "cart.php?mode=checkout" class="button primary gm-full float-right" type="submit" title="Submit">
            Checkout
        </a>
