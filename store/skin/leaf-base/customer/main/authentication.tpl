...
*}
{if $is_https_zone}
    <h1 class="primary-color paragon-text secondary-font mbs mtn">{$lng.lbl_secure_login_form}</h1>
    <p class="text-block">{$lng.txt_secure_login_form}</p>
{else}
    <h1 class="primary-color paragon-text secondary-font mbs mtn">{$lng.lbl_authentication}</h1>
{/if}
