...
<h1 class="primary-color paragon-text secondary-font mbs mtn">{$lng.lbl_confirmation}</h1>

{capture name=dialog}
  {$lng.txt_password_recover_message1} <strong>{$smarty.get.email|escape:"html"}</strong>.
