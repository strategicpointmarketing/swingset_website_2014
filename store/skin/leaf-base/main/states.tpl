{*
4c03b6446c46dc8746c99319f199c24c8e87bb97, v2 (xcart_4_4_0), 2010-07-28 11:02:15, states.tpl, igoryan
vim: set ts=2 sw=2 sts=2 et:
*}
{if $states ne ""}
<select class="gd-full gt-full gm-full mvxs" name="{$name}" id="{$id|default:$name|replace:"[":"_"|replace:"]":""}" {$style}>
{if $required eq "N"}
