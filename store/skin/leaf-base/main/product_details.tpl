{*
99f49a017eeaa96cf5c4060c7785548523d6ad12, v20 (xcart_4_6_2), 2014-01-15 17:46:03, product_details.tpl, mixon
...
{capture name=dialog}
    ...
    <tr>
        ...
        <td colspan="2" class="FormButton">
            <div{if $active_modules.HTML_Editor and not $html_editor_disabled} class="description"{/if}>{*$lng.lbl_short_description*}Additional Information (Configuration):</div>
