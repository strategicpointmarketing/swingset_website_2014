{*
40a664ef6468a9d2e6463b49528f2f93e03afc3e, v8 (xcart_4_4_3), 2011-03-09 07:13:03, spambot_arrest.tpl, aim
...
{elseif $mode eq 'data-table'}
  ...
  <tr>
    ...
    <td class="iv-box">
      <input class="form-input gm-full" type="text" id="{$antibot_input_str_name}" name="{$antibot_input_str_name}"{if $antibot_err} class="err"{/if} />
      {if $button_code}
        <div class="{*button-row*}mvs">
          {$button_code}
        </div>
      {/if}
      {if $config.Image_Verification.spambot_arrest_case_sensitive eq 'Y' && $config.Image_Verification.spambot_arrest_str_generator ne 'numbers'}
