{*
da956935ab977ea64f087b6c5911826fc80eb1f2, v5 (xcart_4_5_4), 2012-10-21 12:58:55, orders_list.tpl, aim
    ...
    <table cellspacing="1" class="data-table width-100" summary="{$lng.lbl_search_results|escape}">
      ...
      {foreach from=$orders item=order name=orders}
        ...
        <tr{interline name=orders}>
          ...
          <td{if $active_modules.XOrder_Statuses && $config.XOrder_Statuses.use_colors eq 'Y'} style="background: #{$order.status|order_status_color} !important;"{/if}>
