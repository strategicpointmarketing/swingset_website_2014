...
<?php if ($this->_tpl_vars['config']['Appearance']['display_np_products'] == 'Y'): ?>
  <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "customer/main/np_products.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>
...
<?php if ($this->_tpl_vars['product_tabs']): ?>
  <?php if ($this->_tpl_vars['show_as_tabs']): ?>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "customer/main/ui_tabs.tpl", 'smarty_include_vars' => array('prefix' => "product-tabs-",'default_tab' => $this->_tpl_vars['config']['Appearance']['default_product_tab'],'mode' => 'inline','tabs' => $this->_tpl_vars['product_tabs'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
  <?php else: ?>
