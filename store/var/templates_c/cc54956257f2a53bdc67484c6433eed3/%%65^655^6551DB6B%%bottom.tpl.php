...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'bottom.tpl', 28, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
      ...
      <td class="store-open-close-link">
        <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "storefront_status.tpl", 'smarty_include_vars' => array('no_container' => true)));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
      </td>
...
" method="post" name="asl_form">
          <input type="hidden" name="redirect" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['php_url']['query_string'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
