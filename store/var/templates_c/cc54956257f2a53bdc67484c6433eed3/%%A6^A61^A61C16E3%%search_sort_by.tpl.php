...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'amp', 'customer/search_sort_by.tpl', 12, false),array('modifier', 'cat', 'customer/search_sort_by.tpl', 12, false),array('modifier', 'escape', 'customer/search_sort_by.tpl', 30, false),)), $this); ?>
<?php func_load_lang($this, "customer/search_sort_by.tpl","lbl_sort_by,lbl_sort_by,lbl_sort_by"); ?><?php if ($this->_tpl_vars['sort_fields'] && ( $this->_tpl_vars['url'] || $this->_tpl_vars['navigation_script'] )): ?>
  ...
  <?php if ($this->_tpl_vars['active_modules']['Advanced_Customer_Reviews'] && $this->_tpl_vars['sort_links']): ?>

    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/Advanced_Customer_Reviews/acr_search_sort_by.tpl", 'smarty_include_vars' => array()));
