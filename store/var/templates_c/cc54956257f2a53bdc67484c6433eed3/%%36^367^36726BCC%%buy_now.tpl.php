...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'customer/main/buy_now.tpl', 15, false),array('modifier', 'escape', 'customer/main/buy_now.tpl', 35, false),array('modifier', 'substitute', 'customer/main/buy_now.tpl', 93, false),array('function', 'getvar', 'customer/main/buy_now.tpl', 20, false),)), $this); ?>
<?php func_load_lang($this, "customer/main/buy_now.tpl","lbl_qty,txt_out_of_stock,lbl_product_quantity_from_to,txt_out_of_stock,txt_need_min_amount"); ?><div class="buy-now">
...
//]]>
  ...
  <?php echo smarty_function_getvar(array('var' => 'product_key','func' => 'func_tpl_get_product_key','product' => $this->_tpl_vars['product'],'featured' => $this->_tpl_vars['featured']), $this);?>

  <?php if ($this->_tpl_vars['active_modules']['Product_Notifications'] != '' && ! $this->_tpl_vars['is_matrix_view']): ?>
...
"<?php if ($this->_tpl_vars['smarty_get_quantity'] == $this->_sections['quantity']['index']): ?> selected="selected"<?php endif; ?>><?php echo $this->_sections['quantity']['index']; ?>
            ...
            <?php if ($this->_tpl_vars['active_modules']['Product_Notifications'] != '' && ! $this->_tpl_vars['is_matrix_view']): ?>
              <?php if ($this->_tpl_vars['config']['Product_Notifications']['prod_notif_enabled_L'] == 'Y' && $this->_tpl_vars['config']['Product_Notifications']['prod_notif_show_in_list_L'] == 'Y' && $this->_tpl_vars['product']['avail'] > $this->_tpl_vars['config']['Product_Notifications']['prod_notif_L_amount']): ?>
...
unset($_smarty_tpl_vars);
 ?>
  ...
  <?php if ($this->_tpl_vars['active_modules']['Socialize'] && $this->_tpl_vars['is_matrix_view'] && ! $this->_tpl_vars['is_a2c_popup']): ?>
