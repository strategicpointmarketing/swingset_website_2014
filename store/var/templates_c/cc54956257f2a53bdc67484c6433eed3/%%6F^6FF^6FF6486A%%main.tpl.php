...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'substitute', 'admin/main/main.tpl', 34, false),array('modifier', 'escape', 'admin/main/main.tpl', 36, false),array('modifier', 'default', 'admin/main/main.tpl', 77, false),array('modifier', 'date_format', 'admin/main/main.tpl', 202, false),array('modifier', 'truncate', 'admin/main/main.tpl', 220, false),array('modifier', 'replace', 'admin/main/main.tpl', 224, false),array('function', 'cycle', 'admin/main/main.tpl', 151, false),array('function', 'currency', 'admin/main/main.tpl', 162, false),array('function', 'inc', 'admin/main/main.tpl', 288, false),)), $this); ?>
<?php func_load_lang($this, "admin/main/main.tpl","txt_your_password_insecured,lbl_chpass,lbl_chpass,lbl_chpass,lbl_chpass,txt_default_passwords_insecured,lbl_users_management,lbl_users_management,txt_blowfish_key_expired,lbl_regenerating_blowfish_key,lbl_regenerating_blowfish_key,txt_auth_code_not_secure,txt_db_backup_expired,lbl_backup_database,lbl_backup_database,txt_rma_new_requests_avail_note,lbl_rma_check_new,lbl_rma_check_new,txt_new_sec_patches_available,lbl_other_updates,lbl_xcart_news,lbl_view_more,txt_top_info_orders,lbl_status,lbl_since_last_log_in,lbl_today,lbl_this_week,lbl_this_month,lbl_complete,lbl_processed,lbl_queued,lbl_failed,lbl_declined,lbl_not_finished,lbl_gross_total,lbl_total_paid,lbl_search_orders,lbl_search_orders,lbl_last_order,lbl_order_id,lbl_order_date,lbl_order_status,lbl_customer,lbl_ordered,lbl_price,lbl_quantity,lbl_options,lbl_gift_certificate,lbl_price,lbl_order_details_label,lbl_order_details_label,lbl_orders_info,txt_top_info_top_sellers,lbl_top_N_products,lbl_since_last_log_in,lbl_today,lbl_this_week,lbl_this_month,txt_no_top_products_statistics,lbl_top_N_categories,lbl_since_last_log_in,lbl_today,lbl_this_week,lbl_this_month,txt_no_top_categories_statistics,txt_no_statistics,lbl_search_orders,lbl_search_orders,txt_how_setup_store_bottom,lbl_top_sellers"); ?><?php if ($this->_tpl_vars['active_modules']['Cloud_Search']): ?>
  <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/Cloud_Search/reminder.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>

<?php if ($this->_tpl_vars['current_passwords_security'] || $this->_tpl_vars['default_passwords_security'] || $this->_tpl_vars['blowfish_key_expired'] || $this->_tpl_vars['db_backup_expired'] || $this->_tpl_vars['new_rma_requests'] || $this->_tpl_vars['not_secure_config_values']): ?>
<?php ob_start(); ?>
...
<?php if ($this->_tpl_vars['blowfish_key_expired'] || $this->_tpl_vars['not_secure_config_values']['security_keys']): ?>
<div class="SecurityWarning">
...
<?php if ($this->_tpl_vars['not_secure_config_values']['auth_code']): ?>
<div class="SecurityWarning">
<?php echo $this->_tpl_vars['lng']['txt_auth_code_not_secure']; ?>
...
<?php if ($this->_tpl_vars['dashboard_news']['security_news']): ?>
<div>
<font class="ErrorMessage"><?php echo $this->_tpl_vars['lng']['txt_new_sec_patches_available']; ?>
</font>
<ul>
<?php $_from = $this->_tpl_vars['dashboard_news']['security_news']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['news']):
?>
<li><?php echo ((is_array($_tmp=@$this->_tpl_vars['news']['description'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['news']['title']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['news']['title'])); ?>
</li>
...
<?php if ($this->_tpl_vars['dashboard_news']['usual_news']): ?>
<div>
<?php echo $this->_tpl_vars['lng']['lbl_other_updates']; ?>

<ul>
<?php $_from = $this->_tpl_vars['dashboard_news']['usual_news']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['news']):
?>
<li><?php echo ((is_array($_tmp=@$this->_tpl_vars['news']['description'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['news']['title']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['news']['title'])); ?>
</li>
...
<?php if ($_COOKIE['hide_dialog_xcart_news'] == '' && $_COOKIE['skip_remote_feeds'] == ''): ?>
...
<?php ob_start(); ?>
<h2><?php echo $this->_tpl_vars['lng']['lbl_xcart_news']; ?>
</h2>
<div id="xcart_news_items"></div>
<div align="right">
<a href='<?php echo $this->_tpl_vars['config']['rss_xcart_news_url']; ?>
' target='_blank'><?php echo $this->_tpl_vars['lng']['lbl_view_more']; ?>
</a>
</div>
<?php $this->_smarty_vars['capture']['dialog'] = ob_get_contents(); ob_end_clean(); ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "location.tpl", 'smarty_include_vars' => array('location' => "",'alt_content' => $this->_smarty_vars['capture']['dialog'],'extra' => 'width="100%"','newid' => 'dialog_xcart_news','alt_type' => 'I','image_none' => 'Y')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>
...
<?php if ($this->_tpl_vars['active_modules']['Kayako_Connector'] != "" && $this->_tpl_vars['kayakoEnabled'] != ""): ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/Kayako_Connector/admin/tickets_summary.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>
