...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'regex_replace', 'customer/buttons/button.tpl', 5, false),array('modifier', 'amp', 'customer/buttons/button.tpl', 13, false),array('modifier', 'default', 'customer/buttons/button.tpl', 34, false),array('modifier', 'strip_tags', 'customer/buttons/button.tpl', 34, false),array('modifier', 'escape', 'customer/buttons/button.tpl', 34, false),)), $this); ?>
...
"<?php endif; ?>>
  ...
  <?php else: ?>
    ...
    <?php echo '<a class="simple-button'; ?><?php if ($this->_tpl_vars['additional_button_class']): ?><?php echo ' '; ?><?php echo $this->_tpl_vars['additional_button_class']; ?><?php echo ''; ?><?php endif; ?><?php echo '" href="'; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['href'])) ? $this->_run_mod_handler('amp', true, $_tmp) : smarty_modifier_amp($_tmp)); ?><?php echo '"'; ?><?php if ($this->_tpl_vars['onclick'] != ''): ?><?php echo ' onclick="'; ?><?php echo $this->_tpl_vars['onclick']; ?><?php echo '; return false;"'; ?><?php endif; ?><?php echo ' title="'; ?><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=@$this->_tpl_vars['title'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['button_title']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['button_title'])))) ? $this->_run_mod_handler('strip_tags', true, $_tmp, false) : smarty_modifier_strip_tags($_tmp, false)))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?><?php echo '"'; ?><?php if ($this->_tpl_vars['target'] != ''): ?><?php echo ' target="'; ?><?php echo $this->_tpl_vars['target']; ?><?php echo '"'; ?><?php endif; ?><?php echo '><span>'; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['button_title'])) ? $this->_run_mod_handler('amp', true, $_tmp) : smarty_modifier_amp($_tmp)); ?><?php echo '</span></a>'; ?>
...
/spacer.gif" alt="<?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=@$this->_tpl_vars['title'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['button_title']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['button_title'])))) ? $this->_run_mod_handler('strip_tags', true, $_tmp, false) : smarty_modifier_strip_tags($_tmp, false)))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"<?php if ($this->_tpl_vars['js_link']): ?> onclick="<?php echo $this->_tpl_vars['js_link']; ?>
...
"<?php endif; ?> />
  ...
  <?php else: ?>
    ...
    <?php echo '<a class="image-button'; ?><?php if ($this->_tpl_vars['additional_button_class']): ?><?php echo ' '; ?><?php echo $this->_tpl_vars['additional_button_class']; ?><?php echo ''; ?><?php endif; ?><?php echo '" href="'; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['href'])) ? $this->_run_mod_handler('amp', true, $_tmp) : smarty_modifier_amp($_tmp)); ?><?php echo '"'; ?><?php if ($this->_tpl_vars['onclick'] != ''): ?><?php echo ' onclick="'; ?><?php echo $this->_tpl_vars['onclick']; ?><?php echo '"'; ?><?php endif; ?><?php echo ' title="'; ?><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=@$this->_tpl_vars['title'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['button_title']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['button_title'])))) ? $this->_run_mod_handler('strip_tags', true, $_tmp, false) : smarty_modifier_strip_tags($_tmp, false)))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?><?php echo '"'; ?><?php if ($this->_tpl_vars['target'] != ''): ?><?php echo ' target="'; ?><?php echo $this->_tpl_vars['target']; ?><?php echo '"'; ?><?php endif; ?><?php echo '><img src="'; ?><?php echo $this->_tpl_vars['ImagesDir']; ?><?php echo '/spacer.gif" alt="" /></a>'; ?>
...
<?php endif; ?>" title="<?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=@$this->_tpl_vars['title'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['button_title']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['button_title'])))) ? $this->_run_mod_handler('strip_tags', true, $_tmp, false) : smarty_modifier_strip_tags($_tmp, false)))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
<?php endif; ?>" type="<?php if ($this->_tpl_vars['type'] == 'input'): ?>submit<?php else: ?>button<?php endif; ?>" title="<?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=@$this->_tpl_vars['title'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['button_title']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['button_title'])))) ? $this->_run_mod_handler('strip_tags', true, $_tmp, false) : smarty_modifier_strip_tags($_tmp, false)))) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"<?php if ($this->_tpl_vars['js_link']): ?> onclick="<?php echo $this->_tpl_vars['js_link']; ?>
"<?php endif; ?><?php if ($this->_tpl_vars['button_id']): ?> id="<?php echo ((is_array($_tmp=$this->_tpl_vars['button_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"<?php endif; ?>>
