...
" onmouseover="javascript:$(this).removeClass('language-code-out').addClass('language-code-over');" onmouseout="javascript:$(this).removeClass('language-code-over').addClass('language-code-out');" /></a>
    ...
    <?php else: ?>
      ...
      <form action="home.php" method="get" name="sl_form">
        <input type="hidden" name="redirect" value="<?php echo ((is_array($_tmp=$_SERVER['PHP_SELF'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php if ($this->_tpl_vars['php_url']['query_string']): ?>?<?php echo ((is_array($_tmp=$this->_tpl_vars['php_url']['query_string'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php endif; ?>" />
