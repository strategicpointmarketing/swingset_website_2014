...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'amp', 'customer/main/navigation.tpl', 7, false),array('modifier', 'escape', 'customer/main/navigation.tpl', 18, false),)), $this); ?>
<?php func_load_lang($this, "customer/main/navigation.tpl","lbl_result_pages,lbl_prev_page,lbl_page,lbl_current_page,lbl_page,lbl_page,lbl_next_page"); ?><?php if (( $this->_tpl_vars['total_pages'] > 2 ) || ( $this->_tpl_vars['per_page'] == 'Y' && $this->_tpl_vars['total_items'] >= $this->_tpl_vars['per_page_values']['0'] )): ?>
