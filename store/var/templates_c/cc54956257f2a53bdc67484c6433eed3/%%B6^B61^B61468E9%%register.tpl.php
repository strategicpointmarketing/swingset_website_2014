...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'customer/main/register.tpl', 66, false),array('modifier', 'substitute', 'customer/main/register.tpl', 109, false),)), $this); ?>
...
" />
        ...
        <?php if ($this->_tpl_vars['active_modules']['XAuth']): ?>
          <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/XAuth/register_link.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
        <?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?>
            ...
            <?php if ($this->_tpl_vars['active_modules']['Adv_Mailchimp_Subscription'] && $this->_tpl_vars['mc_newslists']): ?>
              <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "modules/Adv_Mailchimp_Subscription/customer/register_newslists.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
            <?php endif; ?>
...
unset($_smarty_tpl_vars);
 ?>
            ...
            <tr>
              ...
              <?php if ($this->_tpl_vars['login'] != "" && $this->_tpl_vars['main'] == 'register'): ?>
