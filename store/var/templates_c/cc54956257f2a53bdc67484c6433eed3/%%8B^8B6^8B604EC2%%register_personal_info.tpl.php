...
<?php func_load_lang($this, "main/register_personal_info.tpl","lbl_personal_information,lbl_title,lbl_first_name,lbl_last_name,lbl_company,lbl_ssn,lbl_web_site,lbl_tax_number,lbl_tax_exemption,txt_tax_exemption_assigned,lbl_referred_by,lbl_unknown"); ?><?php if ($this->_tpl_vars['is_areas']['P'] == 'Y'): ?>
