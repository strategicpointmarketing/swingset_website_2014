 ...
 * @version    58ab7bdc89b3d4cd894ef7d853bcc6f0c4dcca6b, v271 (xcart_4_6_2), 2014-02-03 17:25:33, func.user.php, aim
...
function func_userinfo($user, $usertype = '', $need_password = false, $need_cc = '', $profile_area = NULL, $merge_cart_info = true, $use_cache = USE_CACHE)
{
   ...
   if ($use_cache == USE_CACHE) {
    ...
    if ($userinfo['usertype'] == 'C') {
        $userinfo['personal_firstname'] = $userinfo['firstname'];
        $userinfo['personal_lastname'] = $userinfo['lastname'];
    }
