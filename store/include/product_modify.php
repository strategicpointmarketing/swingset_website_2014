 ...
 * @version    58ab7bdc89b3d4cd894ef7d853bcc6f0c4dcca6b, v306 (xcart_4_6_2), 2014-02-03 17:25:33, product_modify.php, aim
    ...
    // If no errors
        ...
        if ($geid && !empty($fields)) {
            ...
            foreach($fields as $k => $v) {
                ...
                if (
                    !in_array($k, array('efields', 'price', 'image', 'thumbnail', 'categoryid', 'categoryids', 'taxes', 'membershipids', 'manufacturer', 'dimensions', 'sp_data', 'taxcloud_data')) &&
        ...
        if (!empty($active_modules['XPayments_Subscriptions'])) {
            if (
                ...
                func_xps_productModify($productid, $subscription, $geid, $xps_fields);
            }
        }
